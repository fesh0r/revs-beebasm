...
.L21AF
    ...
    EQUB &5D, &F4, &91, &E0, &71, &E0, &3E, &24, 3  , &36, &E1, &23
    EQUB &F7, &56, &E0, &36, &E2, &93, &15, &EB, &7A, &6A, &58, &1A
    EQUB &22, &F0, &34, &E5, &CA, &54, &E6, &18, &F8, &E9, &94, &F8
    EQUB &74, &F8, &40, &E7, &61, &F8, &5D, &F8, &0E, &D9, &F1, 0  
    EQUB &F7, &5D, &F9, &11, &AA, &FE, &6A, &E9, &67, &25, &3F, 5  
    ...
    EQUB &49, &16, 1  , &21, &54, &57, &EE, &79, &FE, &38, &1F, &4D
    EQUB &FE, &F0, &81, &C0
.L22AF
    ...
    EQUB &18, &18, &38, &22, 9  , &79, &21, 9  , &53, &FF, &D1, &59
...
.L23AF
    ...
    EQUB &C1, &F2, &D0, &7B, &E1, &5B, &54, &E9, &FC, 1  , &33, &86
    EQUB &62, &C5, &77, &35, &D9, &F9, &42, &BC, 7  , &3E, &C0, &BD
    EQUB &83, &49, &EA, &58, &C6, &91, &89, &E7, &0D, &28, &69, &44
    EQUB &24, &B2, &84, &C6, &C9, &C1, &92, &5E, &C4, &30, &18, &C0
    EQUB &55, &BF, &8F, &ED, &43, 1  , &86, &A2, &C8, &BC, &2B, &11
    EQUB &D1, &96, &6C, &FD, &96, 1  , &49, &78, &96, &1F, 0  , &28
    EQUB &BA, &0D, &B0, &88, &E1, &E0, &AA, &33, &51, &E8, &DA, &AA
    EQUB &5C, &6B, &10, &4A, &A2, &BB, &F9, &43, &8E, &5E, &A7, &AF
    EQUB &F7, &12, &E0, &83, &EB, &25, &1A, &82, &7B, &AA, 0  , &C4
    EQUB &76, &30, &D9, &DD, &19, &26, &EF, &8E, &FA, &79, &D9, &C9
    EQUB &32, &DC, &64, &1A, &4E, &3C, &6F, &CF, &DE, &0E, &B5, &A5
    EQUB &51, &28, &40, &74, &6B, &31, &90, &23, 9  , 7  , &80, &1D
    EQUB &DB, 6  , &15, &A4, &DF, &81, 1  , &BD, &DA, &62, &88, &7B
    EQUB &45, &21, &35, &5F, &76, &58, &59, &81, 5  , &AA, &F4, &EA
    EQUB &A6, &0A, &44, &C3, &C9, &99, &78, &9B, &E6, &7F, &C5, &B4
    EQUB &87, &DA, &17, &8F, &5A, &ED, &23, &5C, &DC, &8C, &ED, &C1
    EQUB &18, &68, &48, &69, 1  , &AA, &86, 0  , &B5, 0  , &20, 5  
    EQUB 1  , &95, 0  , &E8
.L24AF
    EQUB &E0, &F0, &D0, &F4, &60, &20, &0F, 1  , &4D, &45, &FE, &4D
    EQUB &65, &FE, &60, &4D, &44, &FE, &20, &30, 1  , &4D, &44, &FE
    EQUB &2C, &64, &FE, &70, &F8, &4D, &45, &FE, &4D, &64, &FE, &4D
    EQUB &44, &FE, &4D, &45, &FE, &4D, &45, &FE, &2C, &64, &FE, &60
    EQUB &20, &20, 1  , &2C, &44, &FE, &30, &FB, &4D, &45, &FE, &20
    EQUB &29, 1  , &4D, &65, &FE, &4C, &29, 1  , &60, &4C, &2D, 1  
    EQUB &60, 0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  
.RunRevs
    LDX #<(runRevs)
    LDY #>(runRevs)
    JMP oscli
